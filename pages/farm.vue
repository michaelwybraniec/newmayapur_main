    ...
    >
      <div class="order-2 md:px-24 lg:px-0">
        ...
        <p class="pt-3 text-lg">
          ...
          pertaining to agriculture and animal husbandry, and by showing a
          living exemple of what self-sufficiency could be, per Srila
          Prabhupada's desire.
        </p>
      </div>
      <img
      ...
      >
        <div class="order-2 lg:order-1 md:px-24 lg:px-0 mb-24 lg:mb-0">
          ...
          <p class="pt-3 text-lg">
            ...
            maintenance, related to its food consumption.
          </p>
        </div>
        <div class="order-2 lg:order-1 md:px-24 lg:px-0 mb-24 lg:mb-0">
          <div class="p-5 pb-6 mx-auto inline bg-base-100 rounded-xl mb-16">
          ...
          <p class="pt-3 text-lg">
            ...
            existence, through its milk and other by-products.
          </p>
        </div>
        <div class="order-2 lg:order-1 md:px-24 lg:px-0 mb-24 lg:mb-0">
          <div class="p-5 pb-6 mx-auto inline bg-base-100 rounded-xl mb-16">
