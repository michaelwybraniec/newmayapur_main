      ...
      >
        <div class="order-2 md:px-24 2xl:px-0">
          ...
          <p class="pt-3 text-lg">
            ...
            Sri Krishna-Balaram, Sri Sri Radha-Govinda-Madhava.
          </p>
        </div>
        <img
    ...
    >
      <div class="order-2 2xl:order-1 md:px-24 2xl:px-0">
        ...
        <p class="pt-3 text-lg">
          ...
          Bhakti-yoga, through the agency of meditation, wisdom, culture and
          grace, enables us to transform ourselves and our lives. Bhakti refers
          to the expression of the true self, atma, the soul, manifested through
          serving with love. In Sanskrit, yoga means “to connect”. Bhakti-yoga
          is, therefore, a spiritual path meant to reconnect us and awaken our
          love for the Supreme, Whom we call Krsna.
        </p>
      </div>
      <img
        ...
        <div class="border-2 border-base-300 rounded-xl mb-20 lg:mb-0">
          <table class="table table-zebra w-full">
            ...
            <tbody>
              <!-- row 1 -->
              <tr>
                <th class="text-gray-300">1</th>
                <td>04:30</td>
                <td>Mangala Arati</td>
              </tr>
              <!-- row 2 -->
              <tr>
                <th class="text-gray-300">2</th>
                <td>07:30</td>
                <td>Darshan Arati</td>
              </tr>
              <!-- row 3 -->
